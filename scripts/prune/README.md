...
| `teacher.py` | Teacher definition, corpus freeze, calibration split (§5.6, §6). |

Phase 1+ modules named in §12 (`hooks.py`, `chunk_states.py`, `losses.py`,
`metrics.py`, `head_scores.py`, `ffn_scores.py`, `lstsq.py`, `prune_schedule.py`,
